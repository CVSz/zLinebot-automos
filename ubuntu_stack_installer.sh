#!/usr/bin/env bash
# ZEAZ Ubuntu Stack Installer - Project-root generator
# Target: Ubuntu 24.04 VM (VMware 16GB RAM / 300GB NVMe)
# Installs: Docker stack (API, Worker, Postgres, Redis, Kafka, NGINX panels)
# Usage:
#   sudo bash ubuntu_stack_installer.sh --domain zeaz.local [--app-dir /workspace/zLine/zeaz-stack]

set -euo pipefail

DOMAIN=""
CERT_EMAIL=""
APP_DIR="$(pwd)/zeaz-stack"
EXPORT_ZIP="false"
